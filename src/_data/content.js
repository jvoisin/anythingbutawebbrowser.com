...
const entries = [
  {
    ...
    color: 'orange',
    faicon: 'robot',
    datetime: '2026-07-25 05:00',
    title: 'Mozilla\'s twitter is now about AI',
    body: `In 2026, Mozilla's twitter account, <a href="https://x.com/mozilla">@mozilla</a> has been twitting
	   exclusively about AI. There is still their <a href="https://mastodon.social/@mozilla">mastodon account</a>,
	  which posted 7 toots since its creation in 2017, with half of them being also about AI.`,
    links: [
      {
        href: 'https://x.com/mozilla',
        linkText: 'Mozilla’s twitter account',
      },
      {
        href: 'https://mastodon.social/@mozilla',
        linkText: 'Mozilla’s Mastodon account',
      },
    ],
  },
  {
